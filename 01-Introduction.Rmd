...
```{r, fig.cap="Share of population vaccinated", message=FALSE, warning=FALSE, dpi=300, include=FALSE, out.height="10%"}
...
symbols(seq(0, 70, length.out = 9), 
        ...
        squares = at_latest$share_vaccinated, xlim = c(-1,71),inches=0.6,
         xaxt='n', ann=FALSE, yaxt='n', axes = FALSE, 
        )
