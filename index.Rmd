...
| :---: | :---: | :---: | :---: | :---: | :---: |
| 03-07-2022 | 11:00am - 3:30pm | TC.4.04 | Introduction to R | WIP | [**R for Data Science**](https://r4ds.had.co.nz/index.html) |
| 03-14-2022 | 11:00am - 3:30pm | TC.4.04 | | | [**Lost in Data Translation**](https://www.ama.org/marketing-news/lost-in-data-translation/), [**Data Science and the Art of Persuasion**](https://hbr.org/2019/01/data-science-and-the-art-of-persuasion) |
...
```{r  echo = FALSE, output='asis', fig.width=5, fig.height=4, fig.margin=TRUE, dpi=300} 
library(ggplot2)
library(ggthemes)
...
heart <- ggplot(circle, aes(heart_x, heart_y), color = 'red', fill = 'red') +
  geom_polygon(fill = 'firebrick') +
  labs(title = "Made with", caption = "at the Institute for Retailing & Data Science at WU")  +
  theme_tufte() + 
  theme(
